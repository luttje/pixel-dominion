...
-- As such, it guides the pathfinder to the directive, helping it to decide which route is the best.
--
...
-- from the start location to the directive. These functions share the same prototype:
