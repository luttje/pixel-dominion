-- Original Source: https://github.com/MrcSnm/Love2D-Nine-and-Three-Slices/blob/a57f48e384424fb439edc3a30304513290918868/libs/graphics/NineSlice.lua
-- Modified for our use case.
NineSlice = DeclareClass('NineSlice')

function NineSlice:initialize(texture, topLeft, topMid, topRight, midLeft, mid, midRight, botLeft, botMid, botRight)
